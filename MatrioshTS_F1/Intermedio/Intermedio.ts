/*
    Archivo intermedio modificado
    modificaciones = 3
*/

let array = [32, 21, 7, 89, 56, 909, 109, 2];
//let indice = `indice [${array[0]}]`; -- no se valido cadenas con expresiones 
...
let exp = [1,2,3,4,5,6];
let arr = [1,2,3,4,5,6];
//for(let i in [1,2,3,4,5,6]){ -- solo se valido pasar un arreglo por id
for(let i in exp){
