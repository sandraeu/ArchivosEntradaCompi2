/**
    Archivo Sentencias 
    Modificaciones : 
    - En metodo forIn_forOf se comentaron los ciclos for y se llevaron al switch seguido de la llamada al metodo
    - En el metodo sentencias se agrego una instruccion en el else ya que no se valido en la gramatica un else sin instrucciones 
    - el metodo switch_ se comento y sus instrucciones se hicieron globales.
**/
...
function forIn_forOf(): void {
    ...
    */
    ...
    /*** El siguiente codigo se movio por el manejo del for in y for of
